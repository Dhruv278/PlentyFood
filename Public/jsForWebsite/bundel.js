...
if (document.getElementById('ngoform')) {
  document.getElementById('submit').addEventListener('click', function (e) {
    ...
    user.area = document.getElementById('area').value;
    user.pincode = document.getElementById('pincode').value;
    user.user = 'ngo'; //  console.log(user);       
...
if (document.getElementById('foodpage')) {
  document.getElementById('submit').addEventListener('click', function (e) {
    ...
    var food_id = document.getElementsByTagName('form')[0].id;
    console.log(food_id);
...
if (document.getElementById('submittoken')) {
  document.getElementById('submittoken').addEventListener('click', function (e) {
    e.preventDefault();
    var id = document.getElementsByTagName('form')[0].id;
            ...
            if (res.data.status == 'success') {
              ...
              if (res.data.user == 'donor') {
                ...
                window.setTimeout(function () {
                  location.assign("/dsahbord/donor/".concat(res.data.donor._id));
                }, 0);
              } else if (res.data.user == 'receiver') {
                console.log('working');
                window.setTimeout(function () {
                  location.assign("/dsahbord/receiver/".concat(res.data.receiver._id));
                }, 0);
              } else if (res.data.user == 'ngo') {
                window.setTimeout(function () {
                  location.assign("/dsahbord/ngo/".concat(res.data.ngo._id));
                }, 0);
              }
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            alert(_context2.t0.response.data.msg);
...
var addFood = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(food, id) {
    var res;
...
var sendtoken = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(id, token) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            ...
            alert(_context4.t0.response.data.msg);
  ...
  return function sendtoken(_x5, _x6) {
    return _ref4.apply(this, arguments);
  };
}();

function getToken() {
  console.log('working function'); // tokenField = document.getElementById(`${id}`);
  // tokenField.innerHTML = "This is Your Token";
  // tokenField.style.display = "block";
}

if (document.getElementById('pincodeForm')) {
  document.getElementById('submitPincode').addEventListener('click', function (e) {
    e.preventDefault();
